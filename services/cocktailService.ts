...
const popularCocktails: Record<string, Cocktail> = {
  mojito: {
    ...
    english_description:
      "A refreshing rum cocktail originating from Cuba, known for its fresh mint, lime, and soda water flavors.",
    match_reason:
      "这款低酒精度的清爽鸡尾酒非常受欢迎。莫吉托制作简单，不需要专业工具，且口感清新，带有薄荷和青柠的香气。",
    english_match_reason:
      "This low-alcohol refreshing cocktail is very popular. The Mojito is simple to make, requires no professional tools, and has a fresh taste with mint and lime aromas.",
    base_spirit: "朗姆酒",
    ...
    ingredients: [
      ...
      },
      {
        ...
        unit: "ml",
        substitute: "白砂糖",
        english_name: "Simple Syrup",
        english_substitute: "White Sugar",
      },
      {
        name: "薄荷叶",
        amount: "8-10",
      ...
      },
      {
        name: "苏打水",
        amount: "适量",
        english_name: "Soda Water",
        english_amount: "to top",
      },
      {
        name: "冰块",
        amount: "适量",
        english_name: "Ice Cubes",
        english_amount: "to fill",
      },
    ],
    tools: [
      {
        name: "高球杯",
        alternative: "任何玻璃杯",
        english_name: "Highball Glass",
        english_alternative: "Any glass",
      },
      {
        name: "调酒勺",
        alternative: "长柄勺",
        english_name: "Bar Spoon",
        english_alternative: "Long spoon",
      },
      {
        name: "捣棒",
        alternative: "木勺",
        english_name: "Muddler",
        english_alternative: "Wooden spoon",
      },
    ],
    steps: [
      {
        ...
        english_description:
          "Place mint leaves and simple syrup in the glass, gently muddle the mint leaves to release their aroma.",
        tips: "注意不要过度捣碎薄荷叶，以免苦味释放。",
        english_tips:
          "Be careful not to over-muddle the mint leaves to avoid releasing bitterness.",
      },
      {
        step_number: 2,
        ...
        english_tips:
          "Adding lime juice first helps dissolve the sugar better.",
      },
      {
        step_number: 3,
      ...
      },
      {
        ...
        english_description:
          "Garnish with mint leaves and lime slices, then serve.",
        tips: "饮用前轻轻搅拌，让风味更均匀。",
        english_tips:
          "Give it a gentle stir before drinking to ensure even flavor distribution.",
      },
    ],
  },
  margarita: {
    ...
    english_description:
      "A classic tequila cocktail known for its perfectly balanced sweet and sour taste and salted rim.",
    match_reason:
      "这款经典鸡尾酒平衡了龙舌兰的烈性与青柠的酸甜，是世界上最受欢迎的鸡尾酒之一。",
    english_match_reason:
      "This classic cocktail balances the strength of tequila with the sweet and sour taste of lime, making it one of the world's most popular cocktails.",
    base_spirit: "龙舌兰",
    ...
    ingredients: [
      ...
      },
      {
        ...
        amount: "适量",
        substitute: "粗海盐",
        english_name: "Fine Salt",
        english_substitute: "Coarse Sea Salt",
        english_amount: "to rim",
      },
      {
        name: "冰块",
        amount: "适量",
    ...
    tools: [
      {
        name: "玛格丽特杯",
        alternative: "鸡尾酒杯",
        english_name: "Margarita Glass",
        english_alternative: "Cocktail Glass",
      },
      {
        name: "雪克杯",
        alternative: "密封容器",
        english_name: "Shaker",
        english_alternative: "Sealed Container",
      },
      {
        name: "调酒勺",
        alternative: "长柄勺",
    ...
    steps: [
      {
        ...
        english_description:
          "Wet the rim of the glass with a lime wedge, then invert the glass onto a plate of salt to create a salt rim.",
        tips: "只在杯口外侧沾盐，避免盐进入酒中。",
        english_tips:
          "Only salt the outside of the rim to avoid salt getting into the drink.",
      },
      {
        step_number: 2,
        description: "将龙舌兰酒、君度橙酒、青柠汁和冰块放入雪克杯中。",
        english_description:
          "Add tequila, Cointreau, lime juice, and ice to the shaker.",
      ...
      },
      {
        ...
        english_description:
          "Shake vigorously for about 15 seconds until the shaker is frosted.",
        tips: "充分摇晃可以确保酒液充分混合和冷却。",
        english_tips:
          "Thorough shaking ensures proper mixing and cooling of the drink.",
      },
      {
        step_number: 4,
      ...
      },
      {
        ...
        english_tips:
          "Adjust the sweet and sour balance to taste by adding more or less simple syrup or lime juice.",
      },
    ],
  },
  cosmopolitan: {
    ...
    english_description:
      "An elegant vodka cocktail known for its beautiful pink color and the sweet-tart taste of cranberry.",
    match_reason:
      "这款时尚的鸡尾酒在90年代因《欲望都市》而走红，口感平衡，外观精致。",
    english_match_reason:
      "This stylish cocktail gained popularity in the 90s through 'Sex and the City', featuring a balanced taste and elegant appearance.",
    base_spirit: "伏特加",
    ...
    ingredients: [
      {
        ...
        unit: "ml",
        substitute: "普通伏特加",
        english_name: "Citrus Vodka",
        english_substitute: "Regular Vodka",
      },
      { name: "君度橙酒", amount: "20", unit: "ml", english_name: "Cointreau" },
      {
        name: "蔓越莓汁",
    ...
    steps: [
      {
        ...
        english_description:
          "Add vodka, Cointreau, cranberry juice, lime juice, and ice to the shaker.",
        tips: "使用冰冷的杯具可以保持饮品的低温。",
        english_tips:
          "Using chilled glassware helps maintain the drink's temperature.",
      },
      {
        step_number: 2,
        description: "用力摇晃约15秒，直到雪克杯外壁结霜。",
        ...
        english_tips:
          "Thorough shaking ensures proper mixing and achieves the ideal dilution.",
      },
      {
        step_number: 3,
        ...
        english_tips:
          "Using a chilled glass helps maintain the drink's temperature longer.",
      },
      {
        step_number: 4,
        ...
        english_tips:
          "Gently squeeze the citrus peel to release essential oils and add aroma.",
      },
    ],
  },
};
