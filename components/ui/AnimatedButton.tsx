...
export default function AnimatedButton({
  ...
  // 基础样式
  const baseStyles = "relative overflow-hidden font-medium rounded-full transition-all"

  // 变体样式
  const variantStyles = {
    primary: "bg-gradient-to-r from-amber-500 to-pink-500 hover:from-amber-600 hover:to-pink-600 text-white shadow-lg",
    secondary: "bg-white/10 hover:bg-white/20 border border-white/20 text-white",
    outline: "bg-transparent border border-gray-700/50 hover:bg-white/5 text-white",
  ...
  return (
    <button type={type} className={buttonStyles} onClick={handleClick} disabled={disabled || isLoading}>
