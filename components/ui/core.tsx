...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: "primary" | "secondary" | "outline" | "ghost" | "link" | "neon" | "bubble" | "shine"
  size?: "xs" | "sm" | "md" | "lg" | "xl"
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantStyles = {
      ...
      ghost: "bg-transparent hover:bg-accent/10 text-foreground active:scale-95",
    ...
    const disabledStyles = props.disabled || isLoading ? "opacity-50 cursor-not-allowed" : "cursor-pointer"
...
export const CardTitle = forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ children, className = "", ...props }, ref) => {
    return (
      <h3 ref={ref} className={`text-xl font-bold font-playfair ${className}`} {...props}>
        {children}
      </h3>
    )
  },
...
export const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ children, className = "", ...props }, ref) => {
    return (
      <p ref={ref} className={`text-muted-foreground text-sm font-source-sans leading-relaxed ${className}`} {...props}>
        {children}
      </p>
    )
  },
...
export const Divider = forwardRef<HTMLDivElement, DividerProps>(
  ({ className = "", orientation = "horizontal", label, ...props }, ref) => {
    if (orientation === "vertical") {
      return <div ref={ref} className={`h-full w-px bg-gray-700 mx-2 ${className}`} {...props} />
    }

    if (label) {
      return (
        <div ref={ref} className={`relative w-full flex items-center my-4 ${className}`} {...props}>
    ...
    return <div ref={ref} className={`w-full h-px bg-gray-700 my-4 ${className}`} {...props} />
  },
)
...
export const Container = forwardRef<HTMLDivElement, ContainerProps>(
  ({ children, className = "", size = "lg", centered = false, ...props }, ref) => {
    const sizeStyles = {
      sm: "max-w-screen-sm",
      md: "max-w-screen-md",
      lg: "max-w-screen-lg",
...
export const GradientText = forwardRef<HTMLSpanElement, GradientTextProps>(
  ({ as: Component = "span", children, className = "", from = "primary", to = "secondary", ...props }, ref) => {
    return (
      <Component ref={ref} className={`gradient-text font-playfair font-bold ${className}`} {...props}>
        {children}
      </Component>
    )
  },
